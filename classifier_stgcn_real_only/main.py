...
data_path = "D:/PBL4/STEP-master/STEP-master/data"
print(data_path)
ftype = ''
coords = 3
joints = 16
...
#     pr.train()
# else:
pr = processor.Processor(args, data_loader, coords, num_classes, graph_dict, device=device, verbose=False)

# labels_pred, vecs_pred = pr.generate_predictions(data, num_classes, joints, coords)
pr.generate_confusion_matrix(ftype, data_train, labels_train, num_classes, joints, coords)
# pr.load_model("D:/PBL4/STEP-master/STEP-master/classifier_stgcn_real_only/model_classifier_stgcn/features/epoch395_acc81.25_model.pth.tar")
