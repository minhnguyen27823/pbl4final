...
data_path = "D:/PBL4/STEP-master/STEP-master/classifier_hybrid/data"
ftype = ''
coords = 3
joints = 16
cycles = 1
...
parser.add_argument('--num_epoch', type=int, default=3000, metavar='NE',
...
# pr.load_model("D:/PBL4/STEP-master/STEP-master/classifier_hybrid/model_classifier_combined2/features/epoch532_acc84.38_model.pth.tar")
